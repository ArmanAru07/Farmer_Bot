                        ...
                        <div id="drawer-navigation" className={`  ${showDrawer ? '' : '-translate-x-full'}   lg:left-2  z-40 h-screen p-4 overflow-y-auto transition-transform   w-60 bg-black`} tabIndex="-1" aria-labelledby="drawer-navigation-label">
                            ...
                            <div class="py-4 overflow-y-auto">
                                <ul class="space-y-2 font-medium">
                                    ...
                                    <li>
                                        <Link to="/Dashboard/manageSeller" class="flex items-center p-2 text-white  hover:text-gray-900 rounded-lg rounded-r-full rounded-r-full placeholder: dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            <svg class="flex-shrink-0 w-6 h-6 text-gray-100 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
                                                <FaEdit />
                                            </svg>
...

                                    {
                                        isDoc &&
                                        <li>
                                            <Link to="/Dashboard/docAppointment" class="flex items-center p-2 text-white  hover:text-gray-900 rounded-lg rounded-r-full rounded-r-full placeholder: dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                                ...
                                                <span class="ml-3">Doc Appointments</span>
                                            </Link>
                                        </li>
                                    }
