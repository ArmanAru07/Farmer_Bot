...
const TestMain = () => {
    return (
        <div style={{ backgroundColor: '#111827' }} class="min-h-screen py-12 mb-1">
            <section>
                <h2 class="text-4xl font-extrabold text-center text-gray-100">Select Your Test</h2>
                <p class="text-center text-gray-300 text-md">Screening of Patient Health Questionnaire (PHQ-9).</p>
