        ...
        <div style={{ backgroundColor: '#111827' }}>
            ...
            <div className="min-h-screen p-6  flex items-center justify-center mb-1 pb-20">
                ...
                <div className="container max-w-screen-lg mx-auto">
                    ...
                    <h2 className="font-semibold text-3xl mb-1 text-white">Screening of suicidal behaviour (SBQ-R)Screening of anxiety/ Generalized Anxiety Disorder (GAD-7)</h2>
                    ...
                    <div style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.5)), url(${image})`, backgroundSize: 'cover' }} className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6 mt-10">
                        <form onSubmit={handleForm} className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-8 text-left">
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'>Feeling nervous, anxious, or on edge </label>
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'>Not being able to stop or control worrying  </label>
                                <select name="worrying" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'>Worrying too much about different things  </label>
                                <select name="worrying2" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'>Trouble relaxing </label>
                                <select name="relaxing" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
                            ...
                            <div className="mt-10 md:col-span-8">
                                <label htmlFor="address" className='text-base text-white'> Being so restless that it's hard to sit still.</label>
                                <select name="restless" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'> Becoming easily annoyed or irritable  </label>
                                <select name="annoyed" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
                            ...
                            <div className="mt-10 md:col-span-4">
                                <label htmlFor="address" className='text-base text-white'> Feeling afraid as if something awful might happen  </label>
                                <select name="afraid" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" required>
                                    <option value="">Please select one…</option>
                                    <option value="0">Not at all</option>
                                    <option value="1">Several days</option>
                                    <option value="2">More than half the days</option>
